...
class Meta_Description {
	...
	public function __construct() {
		...
		add_action( 'chcd_meta_description_tag', [ $this, 'description' ] );
	...
	public function description() {
		...
		if ( chcd_acf_options() ) {
			 ...
			 */
			$acf_blog_desc = get_field( 'chcd_meta_blog_description', 'option' );
			...
			$wp_blog_desc = get_option( 'chcd_meta_blog_description' );
		...
		$search_meta_desc = apply_filters( 'chcd_meta_description_search', $search_desc );
		...
		$meta_description = apply_filters( 'chcd_meta_description', $description );
 ...
 */
function chcd_meta_description() {
