...
<!-- Dublin Core meta -->
<meta name="DC.Title" content="<?php esc_attr( do_action( 'chcd_meta_title_tag' ) ); ?>" />
<meta name="DC.Format" content="text/html" />
<meta name="DC.Identifier" content="<?php esc_attr( esc_url( do_action( 'chcd_meta_url_tag' ) ) ); ?>"/>
...
<?php if ( is_singular() ) : ?>
<meta name="DC.Contributor" content="<?php esc_attr( do_action( 'chcd_meta_author_tag' ) ); ?>" />
<?php endif; ?>
<?php if ( is_single() ) : ?>
