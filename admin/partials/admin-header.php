...
$title       = apply_filters( 'chcd_admin_header_title', $title );
$description = apply_filters( 'chcd_admin_header_description', $description );
$menu        = apply_filters( 'chcd_admin_header_menu', $menu );
?>
<?php do_action( 'chcd_before_admin_header' ); ?>
<header class="chcd-admin-header">
    <?php do_action( 'chcd_before_admin_site_branding' ); ?>
    ...
    <?php do_action( 'chcd_after_admin_site_branding' ); ?>
    <?php do_action( 'chcd_before_admin_navigation' ); ?>
    ...
    <?php do_action( 'chcd_after_admin_navigation' ); ?>
</header>
<?php do_action( 'chcd_after_admin_header' ); ?>