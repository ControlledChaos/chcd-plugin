...
<h3><?php echo sprintf(
	'%1s %2s %3s',
	__( 'More information about the', 'chcd-plugin' ),
	get_bloginfo( 'name' ),
	__( 'plugin', 'chcd-plugin' )
); ?></h3>
<h4><?php _e( 'The plugin source', 'chcd-plugin' ); ?></h4>
<p><?php _e( 'Following is the the link to this plugin as it comes out of the box. Change this information to complement your site-specific version.', 'chcd-plugin' ); ?></p>
<p><a href="https://github.com/ControlledChaos/chcd-plugin" target="_blank">https://github.com/ControlledChaos/chcd-plugin</a></p>
<h4><?php _e( 'Ask for development help', 'chcd-plugin' ); ?></h4>
<?php echo sprintf(
