...
$page_tabs = apply_filters( 'chcd_tabs_development', $tabs );
...
if ( 'general' == $active_tab ) {
    $section = 'chcd-site-development-general';
    $fields  = 'chcd-site-development-general';
} else {
    $section = null;
    $fields  = null;
}
...
$do_section = apply_filters( 'chcd_section_development', $section );
$do_fields  = apply_filters( 'chcd_fields_development', $fields );
