...
class Users_Callbacks {
	...
	public function block_gravatar( $args ) {
		...
		$option = get_option( 'chcd_block_gravatar' );

		$html = '<p><input type="checkbox" id="chcd_block_gravatar" name="chcd_block_gravatar" value="1" ' . checked( 1, $option, false ) . '/>';

		$html .= '<label for="chcd_block_gravatar"> ' . $args[0] . '</label></p>';
