...
<div class="welcome-panel-content custom">
	<?php do_action( 'chcd_welcome_panel_content_before' ); ?>
	...
	<div class="welcome-panel-column-container">
		<?php do_action( 'chcd_welcome_panel_column_container_before' ); ?>

		<div class="welcome-panel-column">
			<?php do_action( 'chcd_welcome_panel_column_first_before' ); ?>

				<?php if ( is_active_sidebar( 'chcd_welcome_widget_first' ) ) {

					dynamic_sidebar( 'chcd_welcome_widget_first' );
			...
			<?php do_action( 'chcd_welcome_panel_column_first_after' ); ?>
		</div>
		<div class="welcome-panel-column">
			<?php do_action( 'chcd_welcome_panel_column_second_before' ); ?>

			<?php if ( is_active_sidebar( 'chcd_welcome_widget_second' ) ) {

					dynamic_sidebar( 'chcd_welcome_widget_second' );
			...
			<?php do_action( 'chcd_welcome_panel_column_second_after' ); ?>
		</div>
		<div class="welcome-panel-column welcome-panel-last">
			<?php do_action( 'chcd_welcome_panel_column_last_before' ); ?>

			<?php if ( is_active_sidebar( 'chcd_welcome_widget_last' ) ) {

					dynamic_sidebar( 'chcd_welcome_widget_last' );
			...
			<?php do_action( 'chcd_welcome_panel_column_last_after' ); ?>
		</div>

		<?php do_action( 'chcd_welcome_panel_column_container_after' ); ?>
	</div>

	<?php do_action( 'chcd_welcome_panel_content_after' ); ?>
</div>
<?php do_action( 'chcd_after_welcome_panel_content' ); ?>