			...
			acf_add_local_field_group( [
				...
				'fields' => [
					...
					[
						...
						'label'             => __( 'Dashboard', 'chcd-plugin' ),
						'name'              => '',
						'type'              => 'tab',
					...
					[
						...
						'label'             => __( 'Custom Welcome', 'chcd-plugin' ),
						'name'              => 'chcd_custom_welcome',
						'type'              => 'true_false',
						'instructions'      => __( '', 'chcd-plugin' ),
						'required'          => 0,
						'conditional_logic' => 0,
						...
						'message'           => __( 'Use the custom Welcome panel on the Dashboard', 'chcd-plugin' ),
						'default_value'     => 0,
						'ui'                => 0,
						'ui_on_text'        => '',
						'ui_off_text'       => '',
					...
					[
						...
						'label'             => __( 'Remove Welcome Dismiss', 'chcd-plugin' ),
						'name'              => 'chcd_remove_welcome_dismiss',
						'type'              => 'true_false',
						'instructions'      => __( '', 'chcd-plugin' ),
						'required'          => 0,
						'conditional_logic' => 0,
						...
						'message'           => __( 'Remove the Welcome panel dismiss button.', 'chcd-plugin' ),
						'default_value'     => 0,
						'ui'                => 0,
						'ui_on_text'        => '',
						'ui_off_text'       => '',
					...
					[
						...
						'label'             => __( 'Hide Widgets', 'chcd-plugin' ),
						'name'              => 'chcd_dashboard_hide_widgets',
						'type'              => 'checkbox',
						'instructions'      => __( 'Select the Dashboard widgets to hide.', 'chcd-plugin' ),
						'required'          => 0,
						'conditional_logic' => 0,
						'wrapper' => [
							'width' => '',
						...
						'choices'           => [
							'gutenberg' => __( 'Try Gutenberg', 'chcd-plugin' ),
							'welcome'   => __( 'Welcome', 'chcd-plugin' ),
							'news'      => __( 'WordPress News', 'chcd-plugin' ),
							'quick'     => __( 'Quick Press', 'chcd-plugin' ),
							'at_glance' => __( 'At a Glance', 'chcd-plugin' ),
							'activity'  => __( 'Activity', 'chcd-plugin' ),
						],
						'allow_custom'      => 0,
						'save_custom'       => 0,
						'default_value'     => [],
