...
class Settings_Page_Site {
    ...
    public function settings_page() {
		...
		if ( chcd_plugin()->has_acf() ) {
			...
			$position   = get_field( 'chcd_settings_link_position', 'option' );

			// The label of the page in the admin menu.
			$link_label = get_field( 'chcd_site_settings_link_label', 'option' );

			// The icon used for the pagin in the admin menu.
			$link_icon  = get_field( 'chcd_site_settings_link_icon', 'option' );
		...
		// If the Advanced Custom Fields Pro plugin is not active.
			...
			// The label of the page in the admin menu.
			$link_label = sanitize_text_field( get_option( 'chcd_site_settings_link_label' ) );

			// The icon used for the pagin in the admin menu.
			$link_icon  = sanitize_text_field( get_option( 'chcd_site_settings_link_icon' ) );
 ...
 */
function chcd_settings_page_site() {
