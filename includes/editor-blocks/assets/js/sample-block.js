...
( function() {
	...
	*/
	registerBlockType( 'chcd/sample-block', {
		title    : __( 'Sample Block', 'chcd-plugin' ),
		icon     : 'lightbulb',
		category : 'common',

		// The "edit" property must be a valid function.
		edit: function(props) {
			// Creates a <p class='wp-block-chcd-sample-block"'></p>.
			return el(
				'p', // Tag type.
				{ className: props.className }, // The class="wp-block-chcd-sample-block" : The class name is generated using the block's name prefixed with wp-block-, replacing the / namespace separator with a single -.
