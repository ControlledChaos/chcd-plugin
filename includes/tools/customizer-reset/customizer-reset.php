...
namespace CHCD_Plugin\Includes\Tools\Customizer_Reset;
...
final class Customizer_Reset {
	...
	public function customize_controls_print_scripts() {
		...
		wp_enqueue_script( 'chcd-customizer-reset', CHCD_URL . 'includes/tools/customizer-reset/assets/js/customizer-reset.js', [ 'jquery' ], '20150120' );

		wp_localize_script( 'chcd-customizer-reset', '_CHCDCustomizerReset', [
			'reset'   => __( 'Reset', 'chcd-plugin' ),
			'confirm' => __( 'Warning! This will remove all changes made to this theme via the Customizer. This action is irreversible.', 'chcd-plugin' ),
			'nonce'   => [
 ...
 */
function chcd_customizer_reset() {
