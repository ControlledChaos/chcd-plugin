...
class CHCD_Beaver_Builder {
	...
	static public function load_modules() {
		...
		require_once CHCD_PATH . 'includes/beaver/modules/basic-example/basic-example.php';
		require_once CHCD_PATH . 'includes/beaver/modules/example/example.php';
	...
	static public function register_fields( $fields ) {
		...
		$fields['chcd-custom-beaver-field'] = CHCD_PATH . 'includes/beaver/fields/custom-fields.php';
		return $fields;
	...
	static public function enqueue_field_assets() {
		...
		wp_enqueue_style( 'chcd-beaver-fields', CHCD_URL . 'includes/beaver/assets/css/fields.css', [], '' );
		wp_enqueue_script( 'chcd-beaver-fields', CHCD_URL . 'includes/beaver/assets/js/fields.js', [], '', true );
...
// Run the class.
$chcd_beaver_builder = new CHCD_Beaver_Builder;