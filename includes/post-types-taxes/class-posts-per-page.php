 ...
 *
 * @since      1.0.0
 * @author     Greg Sweet <greg@chcdzine.com>
...
class Posts_Per_Page {
	...
	public function activate() {
		...
		$current_options   = get_option( 'chcd_ppp_options' );
		$default_options   = [];
		...
		foreach ( $option_type_array as $option_type ) {
			...
			} elseif ( ! empty( $chcd_ppp_options[ $option_type . '_count' ] ) ) {
		...
		update_option( 'chcd_ppp_options', $default_options );
	...
	public function register_settings() {
		...
		register_setting( 'chcd_ppp_options', 'chcd_ppp_options', [ $this, 'validate_options'] );
	...
	public function output_post_type_count_text() {
		...
		$chcd_ppp_options = get_option( 'chcd_ppp_options' );
		...
		$args            = apply_filters( 'chcd_output_post_type_count_text', $args );
		...
		foreach ( $all_post_types as $p => $k ) {
			 ...
			 *  assign a good value. */
			if ( empty( $chcd_ppp_options[ $p . '_count' ] ) ) {
				$chcd_ppp_options[ $p . '_count' ] = 0;
			}

			if ( empty( $chcd_ppp_options[ $p . '_count_paged' ] ) ) {
				$chcd_ppp_options[ $p . '_count_paged' ] = 0;
			}
			...
			<tr>
				...
				<td>
					<label for="chcd_ppp_post_type_count[<?php echo esc_attr( $p ); ?>]"><?php _e( 'First Page:', 'tims' ); ?> </label> <input id="chcd_ppp_post_type_count[<?php echo esc_attr( $p ); ?>]" name="chcd_ppp_options[<?php echo esc_attr( $p ); ?>_count]" size="3" type="text" value="<?php echo esc_attr( $chcd_ppp_options[ $p . '_count' ] ); ?>" />
					&nbsp;
					<label for="chcd_ppp_post_type_count[<?php echo esc_attr( $p ); ?>]"><?php _e( 'Subsequent Pages:', 'tims' ); ?></label> <input id="chcd_ppp_post_type_count[<?php echo esc_attr( $p ); ?>]" name="chcd_ppp_options[<?php echo esc_attr( $p ); ?>_count_paged]" size="3" type="text" value="<?php echo esc_attr( $chcd_ppp_options[ $p . '_count_paged' ] ); ?>" />
				</td>
			</tr>
			<?php
		}
	...
	public function output_index_count_text() {
		...
		$chcd_ppp_options = get_option( 'chcd_ppp_options', [ 'front_count' => 0, 'front_count_paged' => 0 ] );

		?>
		<label for="chcd_ppp_index_count[0]"><?php _e( 'First Page:', 'tims' ); ?> </label> <input id="chcd_ppp_index_count[0]" name="chcd_ppp_options[front_count]" size="3" type="text" value="<?php echo esc_attr( $chcd_ppp_options[ 'front_count' ] ); ?>" />
		&nbsp;
		<label for="chcd_ppp_index_count[1]"><?php _e( 'Subsequent Pages:', 'tims' ); ?> </label> <input id="chcd_ppp_index_count[1]" name="chcd_ppp_options[front_count_paged]" size="3" type="text" value="<?php echo esc_attr( $chcd_ppp_options[ 'front_count_paged' ] ); ?>" />
		<?php
	}
	...
	public function output_category_count_text() {
		...
		$chcd_ppp_options = get_option( 'chcd_ppp_options', [ 'category_count' => 0, 'category_count_paged' => 0 ] );

		?>
		<label for="chcd_ppp_category_count[0]"><?php _e( 'First Page:', 'tims' ); ?> </label> <input id="chcd_ppp_category_count[0]" name="chcd_ppp_options[category_count]" size="3" type="text" value="<?php echo esc_attr( $chcd_ppp_options[ 'category_count' ] ); ?>" />
		&nbsp;
		<label for="chcd_ppp_category_count[1]"><?php _e( 'Subsequent Pages:', 'tims' ); ?> </label> <input id="chcd_ppp_category_count[1]" name="chcd_ppp_options[category_count_paged]" size="3" type="text" value="<?php echo esc_attr( $chcd_ppp_options[ 'category_count_paged' ] ); ?>" />
		<?php
	}
	...
	public function output_archive_count_text() {
		...
		$chcd_ppp_options = get_option( 'chcd_ppp_options', [ 'archive_count' => 0, 'archive_count_paged' => 0 ] );

		?>
		<label for="chcd_ppp_archive_count[0]"><?php _e( 'First Page:', 'tims' ); ?> </label> <input id="chcd_ppp_archive_count[0]" name="chcd_ppp_options[archive_count]" size="3" type="text" value="<?php echo esc_attr( $chcd_ppp_options[ 'archive_count' ] ); ?>" />
		&nbsp;
		<label for="chcd_ppp_archive_count[1]"><?php _e( 'Subsequent Pages:', 'tims' ); ?> </label> <input id="chcd_ppp_archive_count[1]" name="chcd_ppp_options[archive_count_paged]" size="3" type="text" value="<?php echo esc_attr( $chcd_ppp_options[ 'archive_count_paged' ] ); ?>" />
		<?php
	}
	...
	public function output_tag_count_text() {
		...
		$chcd_ppp_options = get_option( 'chcd_ppp_options', [ 'tag_count' => 0, 'tag_count_paged' => 0 ] );

		?>
		<label for="chcd_ppp_tag_count[0]"><?php _e( 'First Page:', 'tims' ); ?> </label> <input id="chcd_ppp_tag_count[0]" name="chcd_ppp_options[tag_count]" size="3" type="text" value="<?php echo esc_attr( $chcd_ppp_options[ 'tag_count' ] ); ?>" />
		&nbsp;
		<label for="chcd_ppp_tag_count[1]"><?php _e( 'Subsequent Pages:', 'tims' ); ?> </label> <input id="chcd_ppp_tag_count[1]" name="chcd_ppp_options[tag_count_paged]" size="3" type="text" value="<?php echo esc_attr( $chcd_ppp_options[ 'tag_count_paged' ] ); ?>" />
		<?php
	}
	...
	public function output_author_count_text() {
		...
		$chcd_ppp_options = get_option( 'chcd_ppp_options', [ 'author_count' => 0, 'author_count_paged' => 0 ] );

		?>
		<label for="chcd_ppp_author_count[0]"><?php _e( 'First Page:', 'tims' ); ?> </label> <input id="chcd_ppp_author_count[0]" name="chcd_ppp_options[author_count]" size="3" type="text" value="<?php echo esc_attr( $chcd_ppp_options[ 'author_count' ] ); ?>" />
		&nbsp;
		<label for="chcd_ppp_author_count[1]"><?php _e( 'Subsequent Pages:', 'tims' ); ?> </label> <input id="chcd_ppp_author_count[1]" name="chcd_ppp_options[author_count_paged]" size="3" type="text" value="<?php echo esc_attr( $chcd_ppp_options[ 'author_count_paged' ] ); ?>" />
		<?php
	}
	...
	public function output_search_count_text() {
		...
		$chcd_ppp_options = get_option( 'chcd_ppp_options', [ 'search_count' => 0, 'search_count_paged' => 0 ] );

		?>
		<label for="chcd_ppp_search_count[0]"><?php _e( 'First Page:', 'tims' ); ?> </label> <input id="chcd_ppp_search_count[0]" name="chcd_ppp_options[search_count]" size="3" type="text" value="<?php echo esc_attr( $chcd_ppp_options[ 'search_count' ] ); ?>" />
		&nbsp;
		<label for="chcd_ppp_search_count[1]"><?php _e( 'Subsequent Pages:', 'tims' ); ?> </label> <input id="chcd_ppp_search_count[1]" name="chcd_ppp_options[search_count_paged]" size="3" type="text" value="<?php echo esc_attr( $chcd_ppp_options[ 'search_count_paged' ] ); ?>" />
		<?php
	}
	...
	public function output_default_count_text() {
		...
		$chcd_ppp_options = get_option( 'chcd_ppp_options', [ 'default_count' => 0, 'default_count_paged' => 0 ] );

		?>
		<label for="chcd_ppp_default_count[0]"><?php _e( 'First Page:', 'tims' ); ?> </label> <input id="chcd_ppp_default_count[0]" name="chcd_ppp_options[default_count]" size="3" type="text" value="<?php echo esc_attr( $chcd_ppp_options[ 'default_count' ] ); ?>" />
		&nbsp;
		<label for="chcd_ppp_default_count[1]"><?php _e( 'Subsequent Pages:', 'tims' ); ?> </label> <input id="chcd_ppp_default_count[1]" name="chcd_ppp_options[default_count_paged]" size="3" type="text" value="<?php echo esc_attr( $chcd_ppp_options[ 'default_count_paged' ] ); ?>" />
		<?php
	}
	...
	public function modify_query( $query ) {
		...
		if ( $query->is_home() ) {
			$this->process_options( 'front', $chcd_ppp_options );
		} elseif ( $query->is_post_type_archive( $post_type_array ) ) {
			$current_post_type_object = $query->get_queried_object();
			$this->process_options( $current_post_type_object->name, $chcd_ppp_options );
		} elseif ( $query->is_category() ) {
			$this->process_options( 'category', $chcd_ppp_options );
		} elseif ( $query->is_tag() ) {
			$this->process_options( 'tag', $chcd_ppp_options );
		} elseif ( $query->is_author() ) {
			$this->process_options( 'author', $chcd_ppp_options );
		} elseif ( $query->is_search() ) {
			$this->process_options( 'search', $chcd_ppp_options );
			...
			$this->process_options( 'archive', $chcd_ppp_options );
		} else {
			$this->process_options( 'default', $chcd_ppp_options );
		}
	 ...
	 * @param  $chcd_ppp_options array of options from the database for custom posts per page.
	 * @return void
	 */
	public function process_options( $option_prefix, $chcd_ppp_options ) {

		if ( ! $this->paged_view && ! empty( $chcd_ppp_options[ $option_prefix . '_count' ] ) ) {

			$this->final_options['posts']  = $chcd_ppp_options[ $option_prefix . '_count' ];
			$this->final_options['offset'] = 0;
			$this->final_options['set_count'] = $chcd_ppp_options[ $option_prefix . '_count' ];
			$this->final_options['set_count_paged'] = $chcd_ppp_options[ $option_prefix . '_count_paged' ];

		} elseif ( $this->paged_view & ! empty( $chcd_ppp_options[ $option_prefix . '_count_paged' ] ) ) {

			$this->page_count_offset = ( $chcd_ppp_options[ $option_prefix . '_count_paged' ] - $chcd_ppp_options[ $option_prefix . '_count' ] );
			$this->final_options['offset']  = ( ( $this->page_number - 2 ) * $chcd_ppp_options[ $option_prefix . '_count_paged' ] + $chcd_ppp_options[ $option_prefix . '_count' ] );
			$this->final_options['posts']   = $chcd_ppp_options[ $option_prefix . '_count_paged' ];
			$this->final_options['set_count'] = $chcd_ppp_options[ $option_prefix . '_count' ];
			$this->final_options['set_count_paged'] = $chcd_ppp_options[ $option_prefix . '_count_paged' ];
